...
oraz pomiędzy człowiekiem i komputerem \- \ang{Human-Comput-er Interaction}. %ithack
...
Pierwszy $feature\_$ $extraction.py$ jest odpowiedzialny za obliczenie cech sygnałów wypowiedzi. %ithack
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{standarized}
	\caption{Przykład ustandaryzowanego sygnału}
	\label{rys:opis:ustandaryzowany}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{unstandarized}
...
\begin{table}[hc!]
	...
	\centering
	\input{./app/accuaricy_irytacja_zdziwienie_table.tex}
	\label{tab:irytacja:zdziwienie}
\end{table}
\begin{table}[hc!]
	\caption{Trafność rozróżnienia irytacji i smutku}
	\centering
	\input{./app/accuaricy_irytacja_smutek_table.tex}
...
\begin{table}[hc!]
	...
	\centering
	\input{./app/accuaricy_smutek_strach_table.tex}
...
\begin{table}[hc!]
	...
	\centering
	\input{./app/accuaricy_zdziwienie_zlosc_table.tex}
