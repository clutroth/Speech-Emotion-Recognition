...
Główne składowe zostają uporządkowane w kolejności od największej zmienności do najmniejszej.
...
Algorytm \ref{knn:alg} jest wrażliwy na liczbę cech - wymiarów przestrzeni, w której umieszczana jest obserwacja.
...
Jądro liniowe \ref{eq:svm:kern:lin} jest najprostszą funkcją jądra. 
